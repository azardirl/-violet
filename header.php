...
<body>
    <header class='container-fluid text-center border border-4 border-dark text-light my-4 w-75 '>
        <nav class="row">
...
<?php
				if(!isset($_SESSION['mail_u'])){
                        ...
                        echo '
                                 <a href="index.php" class="col-3">
                                  <i class="fas fa-home">Acceuil</i>
                                 </a>
                                <a href="index.php?action=listUser" class="col-3">
                                    <i class="fas fa-desktop"> Afficher utlisateurs</i>
                                </a>
                                <a href="index.php?action=listAuteur" class="col-3">
                                    <i class="fas fa-th-list"> Liste des Auteurs</i>
                                    </a>
                                <a href="public/pages/deconnexion.php" class="col-3">
...
?>
        ...
        <div class="row">
            <h1 class="col-12 colorh1">Les livres</h1>
        </div>  
    </header>